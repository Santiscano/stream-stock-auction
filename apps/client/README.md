...
**src/theme/useModeTheme** - en la funcion **memoizedValue - palette**
definir el tema por defecto que tendra
**src/layout/dashboard/navbar/components** en la constante **COLORS**
definir el objeto con el nuevo color a asignar
